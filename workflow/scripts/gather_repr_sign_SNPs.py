...
for index, row in corr_table.iterrows():
    ...
    for dataset in datasets:
        current_file=f"../results/filtered/repr_{dataset}/{id}_filtered.tsv"
...
with open(snakemake.input.SNP_template) as SNP_template, \
    open(snakemake.output.repr_sign_table, "w") as outfile:

    old_header = "varid\tFinn_MAF\tUKB_MAF\trsid"
    header_suffix = "repr_phenonames_finn\trepr_pleio_finn\trepr_phenonames_uk\trepr_pleio_uk\n"
